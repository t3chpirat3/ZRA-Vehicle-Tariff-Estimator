    ...
    <div className="max-w-3xl mx-auto py-8">
      <div className="bg-[color:var(--surface)] border border-[color:var(--border)] rounded-2xl shadow-sm p-8 sm:p-10 relative">
        ...
        <div className="prose prose-slate prose-sm sm:prose-base max-w-none text-[color:var(--text-muted)] leading-relaxed space-y-6">
          <section>
            <h3 className="text-lg font-bold text-[color:var(--text)] mb-2">{'1. Acceptance of Terms'}</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-[color:var(--text)] mb-2">{'2. Disclaimer of Accuracy (Calculations are Estimates)'}</h3>
            <p>
            ...
            <p className="mt-2 text-[color:var(--text)] font-semibold">You explicitly acknowledge and agree that:</p>
          ...
          <section>
            <h3 className="text-lg font-bold text-[color:var(--text)] mb-2">{'3. Local Data Storage and "Vehicle Watchlist"'}</h3>
            <p>
            ...
            <p className="mt-2 text-[color:var(--text)] font-semibold">By using these features, you acknowledge and agree that:</p>
            <ul className="list-disc pl-5 mt-2 space-y-2">
              <li>
          ...
          <section>
            <h3 className="text-lg font-bold text-[color:var(--text)] mb-2">{'4. Third-Party Information & Clearing Agents'}</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-[color:var(--text)] mb-2">{'5. No Professional, Financial, or Legal Advice'}</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-[color:var(--text)] mb-2">{'6. Limitation of Liability'}</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-[color:var(--text)] mb-2">{'7. Modifications to the Service'}</h3>
            <p>
          ...
          <section>
            <h3 className="text-lg font-bold text-[color:var(--text)] mb-2">{'8. Governing Law'}</h3>
            <p>
